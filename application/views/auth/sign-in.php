...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets-admin/css/templatemo-style.css">
    <!--
                ...
                <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h2 class="tm-block-title mb-4">Welcome to BigBukber</h2>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-12">
                            <form action="<?= base_url() ?>auth/login" method="post" class="tm-login-form">
